...
-- ===============================================================
-- create object(view) of gold: dw_gold.dim_customers
-- ===============================================================
 ...
 CREATE OR REPLACE VIEW dw_gold.dim_customers AS 
	    SELECT 
		    ...
		    CASE WHEN ci.cst_gndr != 'n/a' THEN ci.cst_gndr -- CRM is the master for gender info.
		            ELSE COALESCE(ca.gen,'n/a') -- 'COALESCE()' works as a chain if ca.gen not NULL -> ca.gen(Female or Male), if ca.gen NULL -> 'n/a'
				END AS gender,
	...
	-- ================================================================
-- create object(view) of gold: dw_gold.dim_products
-- ================================================================
...
-- ================================================================
-- create object(view) of gold: dw_gold.fact_sales
-- ================================================================
